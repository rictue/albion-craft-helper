...
const QUICK_LINKS: { keywords: string[]; to: string; label: string }[] = [
  ...
  { keywords: ['cape', 'faction'],                        to: '/capes',         label: 'Cape Converter' },
  { keywords: ['price', 'market', 'aodp'],                to: '/prices',        label: 'Market Prices' },
  { keywords: ['history', 'price history'],               to: '/history',       label: 'Price History' },
  { keywords: ['gold', 'premium'],                        to: '/gold',          label: 'Gold Prices' },
  { keywords: ['planner', 'queue'],                       to: '/planner',       label: 'Craft Planner' },
